...
<body>
  ...
  <header>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav">
            ...
            <?php } else if (isset($_SESSION['funcionario'])) {
            ?>
              <li class="nav-item">
    ...
    <!-- <h1 class="text-center my-5 text-uppercase">Carrousel de maquiagem</h1> -->
    <div class="slider">
      <div class="slide-track">
        <div class="slide"><img src="https://images.pexels.com/photos/3681538/pexels-photo-3681538.png?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="">
        </div>
        <div class="slide"><img src="https://images.pexels.com/photos/2313389/pexels-photo-2313389.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="">
        </div>
        <div class="slide"><img src="https://images.pexels.com/photos/2667528/pexels-photo-2667528.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="">
        </div>
        <div class="slide"><img src="https://images.pexels.com/photos/7066976/pexels-photo-7066976.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="">
        </div>
        <div class="slide"><img src="https://images.pexels.com/photos/2712632/pexels-photo-2712632.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="">
        </div>
        <div class="slide"><img src="https://images.pexels.com/photos/9617681/pexels-photo-9617681.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="">
        </div>
        <div class="slide"><img src="https://images.pexels.com/photos/3614461/pexels-photo-3614461.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="">
        </div>
        <div class="slide"><img src="https://images.pexels.com/photos/16690878/pexels-photo-16690878.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="">
        </div>

        <div class="slide"><img src="img/servicos/01.jpg" alt="">
        </div>
        <div class="slide"><img src="img/servicos/02.jpg" alt="">
        </div>
        <div class="slide"><img src="img/servicos/03.jpeg" alt="">
        </div>
        <div class="slide"><img src="img/servicos/04.jpeg" alt="">
        </div>
        <div class="slide"><img src="img/servicos/05.jpeg" alt="">
        </div>
        <div class="slide"><img src="img/servicos/06.jpeg" alt="">
        </div>
        <div class="slide"><img src="img/servicos/07.jpeg" alt="">
        </div>
        <div class="slide"><img src="img/servicos/08.jpeg" alt="">
        </div>
      </div>
    </div>
    ...
    <div class="container-card d-flex justify-content-center align-items-center">
      <div class="card aos-init aos-animate cards" data-aos="fade-up" data-aos-delay="200" style="width: 18rem;">
        <div class="card-center">
          <img src="https://www.belletag.com/wp-content/uploads/2021/04/before-after-makeup-1-1.jpg" class="card-img-top" alt="...">
        </div>
        <div class="card-body">
          <h5 class="card-title">Noiva</h5>
          <p class="card-text">Nossa cliente Eliane belíssima para seu casamento!</p>
        </div>
      </div>
      <div class="card aos-init aos-animate cards" data-aos="fade-up" data-aos-delay="500" style="width: 18rem;">
        <div class="card-center">
          <img src="https://www.belletag.com/wp-content/uploads/2021/04/before-after-makeup-19-1.jpg" class="card-img-top" alt="...">
        </div>
        <div class="card-body">
          <h5 class="card-title">Artística</h5>
          <p class="card-text">Nossa cliente Barbara arrasando com esse visual!</p>
        </div>
      </div>
      <div class="card aos-init aos-animate cards" data-aos="fade-up" data-aos-delay="800" style="width: 18rem;">
        <div class="card-center">
          <img src="https://www.belletag.com/wp-content/uploads/2021/04/before-after-makeup-11-1.jpg" class="card-img-top" alt="...">
        </div>
        <div class="card-body">
          <h5 class="card-title">Social</h5>
          <p class="card-text">Nossa cliente Sabrina arrasando os corações com nosso serviço!</p>
        </div>
      </div>
    </div>
   ...
   <tbody>
  <?php while($row_servicos=mysqli_fetch_assoc($result)){ 
   ?>
        <td><?php echo $row_servicos['nomeMaquiagem'] ?></td>
        <td>R$<?php echo $row_servicos['valor'] ?>⠀⠀⠀</td>
      ...
      <div class="container text">
        <div class="row py-3">
          ...
          <div class="col-12 col-md-4 text-center">
            <a href="/privacidade.html" class="text-decoration-none text">
              Política de Privacidade
            </a><br>
            <a href="/quemsomos.html" class="text-decoration-none text">
              Quem Somos
            </a><br><br>
