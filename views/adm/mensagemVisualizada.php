...
if(!$_SESSION['admin']){
  ...
  $query ="SELECT * FROM mensagem WHERE situacao='Vizualizado'";
                ...
                <div class="col-12 my-4">
                    <div class="row p-3">
                        ...
                        <?php
                                    ...
                                    ?>
                            <div class="teste mb-3 mt-1">
                            <a href="mensagemPendente.php" style="font-size: 20px;">Pendentes</a>
                            <div class="mx-5"></div>
                            <div class="mx-4"></div>
                            <div class="mx-5"></div>
                            <div class="mx-4"></div>
                            <a href="mensagemVisualizada.php" style="font-size: 20px;">Visualizadas</a>
                        </div>
                      ...
                      <?php while($row=mysqli_fetch_assoc($resultado)){ 
                          ...
                          <tr>
                           ...
                           <td>
                          <a class="a1 mx-3" href="visualizar.php?id=<?php echo $row['idMensagem'] ?>"><img src="../../img/lapis.png" alt=""></a>
                        <a class="a2" href="action/deletarMensagemV.php?id=<?php echo $row['idMensagem'] ?>"><img src="../../img/lixeira.png" alt=""></a>
                         </td>
                        </tr>
                                  <?php }  ?>
                          </tbody>
