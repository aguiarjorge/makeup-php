...
if(!$_SESSION['admin']){
  ...
  $query ="SELECT * FROM mensagem WHERE situacao='Pendente' ";
                            ...
                            <table class="table table-striped table-hover">
                             ...
                             <?php while($row=mysqli_fetch_assoc($resultado)){ 
                                 ...
                                 <td>
                                   ...
                                   <a class="a2" href="action/deletarMensagemP.php?id=<?php echo $row['idMensagem'] ?>"><img src="../../img/lixeira.png" alt=""></a>
                                 </td>
                                 </tr>
                                      <?php }  ?>
                             </tbody>
