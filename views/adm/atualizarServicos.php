...
if(!$_SESSION['admin']){
    ...
    $id=$_GET['id'];
    $sqla="SELECT * FROM maquiagem WHERE idMaquiagem=".$id;
                ...
                <div class="col-12 my-4">
                    <div class="row p-3">
                        ...
                        <div class="col-lg-8 col-md-12 content m-lg-0 a">
                            <form method="POST" action="action/atualizarServicos.php" class="requires-validation" novalidate>
                                <!--ve se consegue deixar invisivel <p>ID: <input type="id"  name="id" value=""></p> -->
                                 <input type="id"  name="id" hidden value="<?php echo $row['idMaquiagem']?>">
                                  <div class="col-md-12 my-3">
                                     <input class="form-control" type="text" name="servico" placeholder="Serviço" value="<?php echo $row['nomeMaquiagem'];?>" required>
                                  </div>
      
                                  <div class="col-md-12">
                                      <input class="form-control" type="text" name="valor" placeholder="Valor" value="<?php echo $row['valor'];?>"required>
                                  </div>
                        <br>
                                  <div class="form-button mt-3">
                                      <button id="submit" type="submit" class="custom-btn btn-1">Validar</button>
                                  </div>
                              </form>
    </section>
    </main>
