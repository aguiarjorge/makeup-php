...
$sqla = 'SELECT * FROM agenda join usuarios on agenda.idUsuario = usuarios.idUsuario where agenda.idAgenda=' . $ida;
$resultado = mysqli_query($conexao, $sqla);
$row = mysqli_fetch_assoc($resultado);

$sql_maquiagem = 'SELECT * FROM maquiagem';
$result_ma = mysqli_query($conexao, $sql_maquiagem);
    ...
    <div class="d-flex flex-column wrapper">
        ...
        <nav class="navbar position-sticky fixed-top navbar-expand-lg navbar-dark bg-dark p-md-3">
            <div class="container-fluid">
                <a href="../../index.php" class="navbar-brand">MAKE UP</a>
                        ...
                        <div class="col-12 my-4">
                            <div class="row p-3">
                                ...
                                <div class="col-lg-4 col-md-12 profile-menu mb-4 m-lg-0">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item seguranca-link">
                                            <a href="verBanner.php" class="nav-link">
                                        ...
                                        <li class="nav-item seguranca-link">
                                            <a href="listarServicos.php" class="nav-link">
                                                <span>Serviços</span>
                                                <i>
                                        ...
                                        <li class="nav-item seguranca-link">
                                            <a href="mensagemPendente.php" class="nav-link">
                                                <span>Mensagens</span>
                                                <i>
                                        ...
                                        <li class="nav-item seguranca-link">
                                            <a href="todosAdm.php" class="nav-link">
                                                <span>Tabela dos Administradores</span>
                                                <i>
                                        ...
                                        <li class="nav-item seguranca-link">
                                            <a href="todosFuncionario.php" class="nav-link ">
                                                <span>Tabela dos Funcionários</span>
                                                <i>
                                                    <ion-icon name="calendar-outline"></ion-icon>
                                                </i>
                                            </a>
                                        ...
                                        <li class="nav-item seguranca-link">
                                            <a href="todosClientes.php" class="nav-link">
                                                <span>Tabela dos Clientes</span>
                                                <i>
                                                    <ion-icon name="calendar-outline"></ion-icon>
                                                </i>
                                            </a>
                                ...
                                <div class="col-lg-8 col-md-12 content m-lg-0 a">
                                    <form action="action/atualizarAgenda.php" method="POST" enctype="multipart/form-data">
                                        <div class="row">

                                            <input type="number" name='id' hidden value="<?php echo $row['idUsuario'] ?>" readonly>
                                            <input type="number" name='idAgenda' hidden value="<?php echo $row['idAgenda'] ?>">


                                            <div class="row">
                                                <div class="col-md-5">
                                                    <label for="nome" class="form-label">Nome</label>
                                                    <input type="text" class="form-control" name='nome' id='nome' value="<?php echo $row['nomeUsuario'] ?>" disabled>
                                                </div>
                                                <div class="col-md-5">
                                                    <label for="email" class="form-label">Email</label>
                                                    <input type="email" class="form-control" name='email' id='email' value="<?php echo $row['emailUsuario'] ?>" disabled>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <label for="telefone" class="form-label">Telofone</label>
                                                    <input type="text" class="form-control" name='telefone' id='telefone' value="<?php echo $row['telefoneUsuario'] ?>" disabled>
                                                </div>

                                                <div class="col-md-5">
                                                    <label for="maquiagem" class="form-label">Categoria</label>
                                                    <select name="maquiagem" id="maquiagem" class="form-select form-select-lg mb-2">
                                                        <option value="<?php echo $row['maquiagem'] ?>"><?php echo $row['maquiagem'] ?></option>

                                                        <?php
                                                        while ($row_ma = mysqli_fetch_assoc($result_ma)) {
                                                        ?>
                                                            <option value="<?php echo $row_ma['nomeMaquiagem'] ?>"><?php echo $row_ma['nomeMaquiagem'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <input type="text" class="form-control" name='data' id='data' value=" <?php echo $row["dataAgenda"] ?>">
                                            </div>
                                            <div class="col-md-5">
                                                <label for="horario" class="form-label">Horario</label>
                                                <input type="text" class="form-control" name='horario' id='horario' value="<?php echo $row['horario'] ?>">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5">
                                                <label for="foto" class="form-label">Foto Atual</label>
                                                <img id="fotoa" src="../cliente/img/<?php echo $row['fotoAtual'] ?>" alt="<?php echo $row['fotoAtual'] ?>">
                                            </div>
                                            <div class="col-md-5">
                                                <label for="horario" class="form-label">Foto Desejada</label>
                                                <img id="fotoa" src="../cliente/img/<?php echo $row['fotoDesejo'] ?>" alt="<?php echo $row['fotoDesejo'] ?>">
                                            </div>
                                        </div>
                                        <br><br><br>
                                        <button type="submit" style="margin-left: 42% !important;" class="custom-btn btn-2">Atualizar</button>

                                    </form>
                                </div>
            </section>
        </main>
        <!-- container come�o fim -->
