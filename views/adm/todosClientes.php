...
if(!$_SESSION['admin']){
    ...
    $sql='SELECT * FROM usuarios JOIN acesso on usuarios.idAcesso = acesso.idAcesso WHERE usuarios.idAcesso=3';
                    ...
                    <div class="row p-3">
                        ...
                        <?php
                            ...
                            <table class="table table-striped table-hover">
                              ...
                              <td>
                                 <a class="a2 mx-3" href="atualizarCliente.php?id=<?php echo $row_Func['idUsuario'] ?>"><img src="../../img/lapis.png" alt=""></a>
                                 <a class="a2" href="action/deletarCliente.php?id=<?php echo $row_Func['idUsuario'] ?>"><img src="../../img/lixeira.png" alt=""></a>
                                  </td>
                              </tr>
                                     <?php }  ?>
                              </tbody>
                             </table>
                             <button style="margin-left: 42% !important;" class="custom-btn btn-6"><a class="a2" href="FormularioInserirNovoCliente.php">Novo</a></button>
                        </div>
    </section>
