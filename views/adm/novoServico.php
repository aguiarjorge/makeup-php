                ...
                <div class="col-12 my-4">
                    <div class="row p-3">
                        ...
                        <div class="col-lg-8 col-md-12 content m-lg-0 a">
                            <form method="POST" action="action/inserirServicos.php" class="requires-validation" novalidate>

                                <div class="col-md-12 my-3">
                                   <input class="form-control" type="text" name="servico" placeholder="Serviço" required>
                                </div>
    
                                <div class="col-md-12">
                                    <input class="form-control" type="text" name="valor" placeholder="Valor" required>
                                </div>
                      <br>
