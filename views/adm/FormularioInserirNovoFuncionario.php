                ...
                <div class="col-12 my-4">
                    <div class="row p-3">
                        ...
                        <div class="col-lg-4 col-md-12 profile-menu mb-4 m-lg-0">
                            <ul class="nav flex-column">
                                <li class="nav-item perfil-link">
                                    <a href="areaAdm.php" class="nav-link perfil-link">
                        ...
                        <div class="col-lg-8 col-md-12 content m-lg-0 a">
                            <form action="action/inserirNovoUsuario.php" method="POST" class="requires-validation" novalidate>

                                <div class="col-md-12">
                                   <input class="form-control my-3" type="text" name="nome" placeholder="Nome" required>
                                </div>
    
                                <div class="col-md-12">
                                    <input class="form-control my-3" type="text" name="cpf" placeholder="CPF" onkeypress="$(this).mask('000.000.000-00');" required>
                                </div>
    
                                <div class="col-md-12">
                                    <input class="form-control my-3" type="text" name="telefone" placeholder="Telefone" onkeypress="$(this).mask('(00) 0000-00009')" required>
                                </div>
    
                                <div class="col-md-12">
                                    <input class="form-control my-3" type="email" name="email" placeholder="E-mail" required>
                                </div>
    
                                <div class="col-md-12">
                                    <input class="form-control my-3" type="password"  name="senha" placeholder="Senha" required>
                                </div>
    
                               <div class="col-md-12">
                                    <select class="form-select mt-3" name="nivel" required>
                                          <option value="2">Funcionário</option>
                                          <option value="3">Cliente</option>                                          
                                          <option value="1">Admiinistrador</option>
                                   </select>
                               </div>
                      
                            <br>
                                <div class="form-button mt-3">
                                    <button id="submit" type="submit" class="custom-btn btn-1">Cadastrar</button>
                                </div>
                            </form>
                        </div>
    </section>
