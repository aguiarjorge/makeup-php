                    ...
                    <div class="row p-3">
                        ...
                        <div class="col-lg-4 col-md-12 profile-menu mb-4 m-lg-0">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item seguranca-link">
                                    <a href="verBanner.php" class="nav-link active">
                        ...
                        <?php
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                             <?php while($row_banner=mysqli_fetch_assoc($row)){ ?>
                             <td><img style="width:220px; ;" src="../../img/banner/<?php echo $row_banner['urlbanner'] ?>" alt="<?php echo $row_banner['urlbanner'] ?>"></td>
                            <td><?php echo $row_banner['urlbanner'] ?></td>
                             <td>
                            <a class="a2" href="action/deletarBanner.php?id=<?php echo $row_banner['idBanner'] ?>"><img src="../../img/lixeira.png" alt=""></a>
                             </td>
                            </tr>
                             <?php }  ?>
                             </tbody>
                             ...
                             <div class="mb-4">
                             <form action="action/uploadBanner.php" method="POST" enctype="multipart/form-data">
                             Adicionar uma nova imagem: <input type="file" required name="arquivo">
                              <input type="submit" value="salvar" class="custom-btn btn-6">
                        </div>
    </section>
</main>
