                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                 <?php while($row_Func=mysqli_fetch_assoc($row)){ 
                                     ?>
                                <td hidden><?php echo $row_Func['idUsuario'] ?></td>
                              ...
                              <td>
                                 ...
                                 <a class="a2 mx-3" href="atualizarAdm.php?id=<?php echo $row_Func['idUsuario'] ?>"><img src="../../img/lapis.png" alt=""></a>
                                <a class="a2" href="action/deletarAdm.php?id=<?php echo $row_Func['idUsuario'] ?>"><img src="../../img/lixeira.png" alt=""></a>
                                  </td>
                              </tr>
                                     <?php }  ?>
                              </tbody>
                             </table>
                             <button style="margin-left: 42% !important;" class="custom-btn btn-6"><a class="a2" href="FormularioInserirNovoAdm.php">Novo</a></button>
    </section>
    </main>
