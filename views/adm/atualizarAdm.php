...
if(!$_SESSION['admin']){
    ...
    $sqla='SELECT * FROM usuarios join acesso on usuarios.idAcesso =acesso.idAcesso WHERE usuarios.idUsuario ='.$id;
                    ...
                    <div class="row p-3">
                        ...
                        <div class="col-lg-4 col-md-12 profile-menu mb-4 m-lg-0">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item seguranca-link">
                                    <a href="todosAdm.php" class="nav-link active">
                        ...
                        <div class="col-lg-8 col-md-12 content m-lg-0 a">
                            <form class="requires-validation" action="action/atualizarUsuario.php" method="POST" novalidate>
                                
                            <input class="form-control my-3" hidden type="text" name="id" placeholder="Nome" value="<?php echo $resultado['idUsuario']?>" required>


                                    <div class="col-md-12">
                                       <input class="form-control my-3" type="text" name="nome" placeholder="Nome" value="<?php echo $resultado['nomeUsuario']?>" required>
                                    </div>
        
                                    <div class="col-md-12">
                                        <input class="form-control my-3" type="text" name="cpf" disabled placeholder="CPF" value="<?php echo $resultado['cpfUsuario']?>" required>
                                    </div>
        
                                    <div class="col-md-12">
                                        <input class="form-control my-3" type="text" name="telefone" placeholder="Telefone" value="<?php echo $resultado['telefoneUsuario']?>" required>
                                    </div>
        
                                    <div class="col-md-12">
                                        <input class="form-control my-3" type="email" name="email" placeholder="E-mail" value="<?php echo $resultado['emailUsuario']?>" required>
                                    </div>
        
                                    <div class="col-md-12">
                                        <input class="form-control my-3" type="password" name="senha" placeholder="Senha" value="<?php echo $resultado['senhaUsuario']?>" required>
                                    </div>
        
                                   <div class="col-md-12">
                                        <select class="form-select mt-3" name="nivel" value="<?php echo $resultado['nivel']?>" required>
                                              <option value="1"><?php echo $resultado['nivel']?></option>
                                ...
                                <br>
                                    <div class="form-button mt-3">
                                        <button id="submit" type="submit" class="custom-btn btn-1">Atualizar</button>
                                    </div>
                                </form>
                        </div>
    </section>
