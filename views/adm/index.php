            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="../login/action/sair.php" target="_blank" class="nav-link" style="color: #FF676D;">SAIR</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="col-lg-8 col-md-12 content m-lg-0 a">
                                    <div class="row p-3">
                                        <div class="col-md-8 col-sm-12 px-0">
                                            <h5><?php echo $_SESSION['nomeUsuario'] ?></h5>
                                            <p></p>
                                        </div>
                                        <div class="col-12 px-0 mt-4 ">
                                            <div class="alert alert-light mb-0 p-3">
                                                <div class="row">
                                                    <div class="col-12 mb-2 teste">
                                                        <img src="check.png" alt="">
                                                        <p>Bem vindo, <?php echo $_SESSION['nomeUsuario'] ?> um otimo dia e um bom trabalho
