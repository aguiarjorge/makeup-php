...
$sqla = 'SELECT * FROM usuarios WHERE idUsuario= ' . $id;
$resulta = mysqli_query($conexao, $sqla);
$linha = mysqli_fetch_array($resulta);
                            ...
                            <div class="row p-3">
                                ...
                                <div class="col-lg-4 col-md-12 profile-menu mb-4 m-lg-0">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item seguranca-link">
                                            <a href="listarServicos.php" class="nav-link active">
                                                <span>Serviços</span>
                                                <i>
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <td>
                                                    <a class="a1 mx-3" href="atualizarServicos.php?id=<?php echo $row_servicos['idMaquiagem'] ?>"><img src="../../img/lapis.png" alt=""></a>
                                                    <a class="a2" href="action/deletarServicos.php?id=<?php echo $row_servicos['idMaquiagem'] ?>"><img src="../../img/lixeira.png" alt=""></a>
                                                </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                                    <button style="margin-left: 42% !important;" class="custom-btn btn-2"><a class="a3" href="novoServico.php">Novo</a></button>
            </section>
        </main>
