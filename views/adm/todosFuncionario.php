...
$sql = 'SELECT * FROM usuarios JOIN acesso on usuarios.idAcesso = acesso.idAcesso WHERE usuarios.idAcesso=2';
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <td><?php echo $row_Func['nomeUsuario'] ?></td>
                                                <td><?php echo $row_Func['cpfUsuario'] ?></td>
                                                <td><?php echo $row_Func['emailUsuario'] ?></td>
                                                <td><?php echo $row_Func['senhaUsuario'] ?></td>
                                                <td><?php echo $row_Func['nivel'] ?></td>
                                                <td>
                                                   <a class="a2 mx-3" href="atualizaFuncionario.php?id=<?php echo $row_Func['idUsuario'] ?>"><img src="../../img/lapis.png" alt=""></a>
                                                   <a class="a2" href="action/deletarFuncionario.php?id=<?php echo $row_Func['idUsuario'] ?>"><img src="../../img/lixeira.png" alt=""></a>
                                                </td>
                                                </tr>
                                            <?php }  ?>
                                        </tbody>
                                    </table>
                                    <button style="margin-left: 42% !important;" class="custom-btn btn-6"><a class="a2" href="FormularioInserirNovoFuncionario.php">Novo</a></button>
                                </div>
            </section>
        </main>
