...
$ida = $_GET['id'];
$query="SELECT * from mensagem where idMensagem ='$ida'";
                    ...
                    <div class="row p-3">
                        ...
                        <div class="col-lg-4 col-md-12 profile-menu mb-4 m-lg-0">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item seguranca-link">
                                    <a href="mensagemPendente.php" class="nav-link active">
                                        <span>Mensagens</span>
                                        <i>
                        ...
                        <div class="col-lg-8 col-md-12 content m-lg-0 a">
                            <form class="requires-validation" method="POST" action="action/atualizarSit.php" novalidate>
                              
                              <p><input class="form-control my-3" type="text" name="id" placeholder="Nome" value="<?php echo $resultado['idMensagem'];?>" hidden></p> 
                              
                           
                                <div class="col-md-12">
                                      <input class="form-control my-3" type="text" name="nome" placeholder="Nome" value="<?php echo $resultado['nome'];?>" disabled required>
                                   </div>
       
                                   <div class="col-md-12">
                                       <input class="form-control my-3" type="email" name="email" placeholder="E-mail" value="<?php echo $resultado['email'];?>"  disabled required>
                                   </div>
       
                                   <div class="col-md-12">
                                       <input class="form-control my-3" type="text" name="assunto" placeholder="Assunto" value="<?php echo $resultado['assunto'];?>" disabled required>
                                   </div>
       
                                   <div class="col-md-12">
                                       <input class="form-control my-3" type="text" name="mensagem" placeholder="Mensagem" value="<?php echo $resultado['mensagem'];?>" disabled required>
                                   </div>
       
                                  <div class="col-md-12">
                                       <select class="form-select mt-3" name="situacao" required>
                                             <option selected disabled value="">Situação</option>
                                             <option value="Pendente">Pendente</option>
                                             <option value="Vizualizado">Vizualizado</option>
                                      </select>
                                  </div>
