                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td>
                                                        <?php echo $row["maquiagem"] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row["funcionario"] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row["dataAgenda"] ?>
                                                    <td>
                                                    ...
                                                    <td class="btn-66">
                                                        <a class="a1 mx-3" href="vizualizarAgenda.php?id=<?php echo $row['idAgenda'] ?>"><img src="../../img/olho.png" alt=""></a>
                                                        <a class="a2" href="action/apagarAgenda.php?id=<?php echo $row['idAgenda'] ?>"><img src="../../img/lixeira.png" alt=""></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
