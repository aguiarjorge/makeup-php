...
$sql = 'SELECT nomeUsuario FROM usuarios WHERE idAcesso=2';
...
<script>
   function validarData() {
            ...
            var dataDigitada = new Date(dataInput.value);
            ...
            <div class="col-12 my-4">
              <div class="row p-3">
                ...
                <div class="col-lg-8 col-md-12 content m-lg-0 a">
                  <form action="action/salvarAgendamento.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col">
                        <p><input type="hidden" name='id' value="<?php echo $_SESSION['idUsuario'] ?>" readonly></p>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        ...
                        <input type="text" class="form-control" name='nome' id='nome' value="<?php echo $_SESSION['nomeUsuario'] ?>">
                      </div>
                      <div class="col-md-5">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" class="form-control" name='email' id='email' value="<?php echo $_SESSION['emailUsuario'] ?>">
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-5">
                        ...
                        <input type="text" class="form-control" name='telefone' id='telefone' value="<?php echo $_SESSION['telefoneUsuario'] ?>" onkeypress="$(this).mask('(00)00000-0000')">
                      </div>
                      <div class="col-md-5">
                        <label for="cpf" class="form-label">CPF</label>
                        <input type="cpf" class="form-control" name='cpf' id='cpf' value="<?php echo $_SESSION['cpfUsuario'] ?>" readonly>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <label for="selectFunc" class="form-label">Escolha o Funcionario</label>
                        <select name="selectFunc" id="selectFunc" class="form-select form-select-lg mb-2">
                          <?php
                          while ($row_Funcionario = mysqli_fetch_assoc($resultado)) {
                          ?>
                            <option value="<?php echo $row_Funcionario['nomeUsuario'] ?>"><?php echo $row_Funcionario['nomeUsuario'] ?> </option>
                          <?php } ?>
                          </select>
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="date" id="data" name="dataAgenda" class="form-control" onkeypress="$(this).mask('00/00/0000')">
                      </div>

                      <div class="col-md-3">
                        <label for="horario" class="form-label">Horario</label>
                        <select name="horario" id="horario" class="form-select form-select-lg mb-2">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-5">
                          Uma foto Atual:
                          <input type="file" id="atual" required name="atual" class="form-control">

                        </div>
                        <div class="col-md-5">
                          Uma foto da maquiagem que deseja:
                          <input type="file" id="previa" required name="previa" class="form-control">
                    ...
                    <button type="submit" class="btn btn-primary" style="margin:20px  0;">Solicitar Agendamento</button>
                  </form>
                </div>
      </section>
    </main>
