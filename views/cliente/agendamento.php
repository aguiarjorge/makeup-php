...
$sql = 'SELECT * FROM agenda where idUsuario=' . $id;
            ...
            <div class="col-12 my-4">
              <div class="row p-3">
                ...
                <div class="col-lg-8 col-md-12 content m-lg-0 a">
                  <h6 class="mt-3 text-center">Para concluir o agendamento é necessário efetuar o pagamento em "Concluir agendamento", com um valor de 50% do total do serviço para garantir sua reserva. Para mais informações, contado em "Atendimento" </h6>
                  <?php
                  if (isset($_GET['add'])) {
                  ...
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          <td class="invisivel"> <?php echo $row["idAgenda"] ?></td>
                          <td> <?php echo $row["maquiagem"] ?></td>
                          <td> <?php echo $row["funcionario"] ?> </td>
                          <td> <?php echo $row["dataAgenda"] ?></td>
                          <td> <?php echo $row["horario"] ?> </td>
                          <td> <?php echo $row["valor"] ?> </td>
                          <td> <?php echo $row["situacao"] ?></td>
                          <td>
                            <a href="finalizar-compra.php?id=<?php echo $row['idAgenda'] ?>">Concluir Agendamento</a>
                          </td>
                        </tr>
                      <?php }  ?>
                    </tbody>
                  </table>
                  <button class="btn mt-4"><a href="ConcluirAgendamento.php" class="btn1">Solicitar</a></button>
                </div>
      </section>
    </main>
