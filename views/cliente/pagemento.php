        ...
        <nav class="navbar position-sticky fixed-top navbar-expand-lg navbar-dark bg-dark p-md-3">
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                  <li class="nav-item">
                    <a href="quemsomos.html" target="_blank" class="nav-link" style="color: #FF676D;">SOBRE</a>
                  </li>
                  <li class="nav-item">
                    <a href="servicos.html" target="_blank" class="nav-link" style="color: #FF676D;">SERVIÇOS</a>
                  </li>
                  <li class="nav-item">
                    <a href="index.html#contact" class="nav-link" style="color: #FF676D;">CONTATO</a>
                  </li>
                  <li class="nav-item">
                    <a href="login.html" target="_blank" class="nav-link" style="color: #FF676D;">LOGIN</a>
                  </li>
                </ul>
              </div>
          </div>
                ...
                <div class="col-12 my-4">
                    <div class="row p-3">
                        ...
                        <div class="col-lg-4 col-md-12 profile-menu mb-4 m-lg-0">
                            <ul class="nav flex-column">
                                <li class="nav-item perfil-link">
                                    <a href="areaCliente.html" class="nav-link perfil-link ">
                        ...
                        <div class="col-lg-8 col-md-12 content m-lg-0 a">
                            <form action="atualizarSitPagamento.php" method="post">

                                <div class="row">
                                    <!-- ve se consegue deixar invisivel <div class="col">
                            ...
                            <div class="row">
                               <div class="col-md-5">
                                ...
                                <input type="cpf" class="form-control" name='cpf' id='cpf' value="">
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mt-5">
                                        ...
                                        <select name="pagamento" id="pagamento" name='pagamento' class="btnsw mx-2">
                                ...
                                <br>
                                <button type ="submit" class="btnsw">Concluir</button>
                                </form>
                        </div>
    </section>
</main>
