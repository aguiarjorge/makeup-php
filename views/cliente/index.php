                                ...
                                <div class="col-lg-8 col-md-12 content m-lg-0 a">
                                    <div class="row p-3">
                                        ...
                                        <div class="col-md-4 col-sm-12 text-right px-0">
                                            <a type="button" href="EditarCliente.php" class="btn btn-editar">Editar perfil</a>
                                        </div>
                                            ...
                                            <div class="alert alert-light mb-0 p-3">
                                                <div class="row">
                                                    <div class="col-12 mb-2 teste">
                                                       ...
                                                       <p>Ola, <?php echo $_SESSION['nomeUsuario'] ?>. Você possui  agendamento!
                                                            <br>
                                                            Se quiser fazer mais agendamentos clique no botão abaixo
                                                        </p>
                                                        <?php }else{?>
                                                            <p>Ola, <?php echo $_SESSION['nomeUsuario'] ?>. Você não possui nenhum agendamento!
                                                            <br>
                                                            Se quiser fazer algum agendamento clique no botão abaixo
                                                        </p>
                                                        <?php }?>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="concluirAgendamento.php" class="btn btn-seguro btn-lg mr-2">Agende aqui</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
