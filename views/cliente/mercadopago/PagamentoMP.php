...
class PagamentoMP
{
   ...
   private $client_id = "7084973357256169";
   private $client_secret = "RgHjvehO9a0ODzrBtdnv4JYotWgDU0PI";
   ...
   public function PagarMP($ref, $nome, $valor, $url)
   {
      ...
      $this->btn_mp = '<script>window.location.href = "' . $link . '";</script>';
...
?>
<img src="../img/1f564c40d80b132b95287606d56b6af9.png" alt="">