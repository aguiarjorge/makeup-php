...
$sql = 'SELECT * FROM agenda where situacao="pago" and funcionario = "' .$nome. '"  ';
          ...
          <div class="row">
            <div class="col-12 my-4">
              <div class="row p-3">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 profile-menu mb-4 m-lg-0">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 content m-lg-0 a">
                  <?php
                  if (isset($_GET['add'])) {
                  ...
                  <table class="table table-striped table-hover">
                    ...
                    <?php while ($row = mysqli_fetch_assoc($resultado)) {
                      ...
                      <tr>
                        ...
                        <td class="btn-66">
                          <a class="a1 mx-3" href="vizualizar.php?id=<?php echo $row['idAgenda'] ?>"><img src="../../img/olho.png" alt=""></a>
                         <a class="a2" href="action/apagar.php?id=<?php echo $row['idAgenda'] ?>"><img src="../../img/lixeira.png" alt=""></a>
                        </td>
                      </tr>
                    <?php } ?>
                    </tbody>
