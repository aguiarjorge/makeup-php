                        ...
                        <div class="col-12 my-4">
                            <div class="row p-3">
                                ...
                                <div class="col-lg-4 col-md-12 profile-menu mb-4 m-lg-0">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item seguranca-link">
                                            <a href="verificarAgendados.php" class="nav-link active">
                                                <span>Horários marcados</span>
                                                <i>
                                ...
                                <div class="col-lg-8 col-md-12 content m-lg-0 a">
                                    <form action="salvarAgendamento.php" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                         
                                                <input type="number" name='id' hidden
                                                    value="<?php echo $row['idUsuario'] ?>" readonly>
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    ...
                                                    <input type="text" class="form-control" name='nome' id='nome'
                                                        value="<?php echo $row['nomeUsuario'] ?>">
                                                </div>
                                                <div class="col-md-5">
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    ...
                                                    <input type="text" class="form-control" name='telefone'
                                                        id='telefone' value="<?php echo $row['telefoneUsuario'] ?>">
                                                </div>
                                                <div class="col-md-5">
                                                    <label for="maquiagem" class="form-label">Maquiagem</label>
                                                    <input type="text" class="form-control" name='maquiagem'
                                                        id='maquiagem' value="<?php  echo $row['maquiagem'] ?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-5">
                                            ...
                                            <br><br><br>
                                            <button style="margin-left: 42% !important;" class="custom-btn btn-2"><a
                                                    class="a3" href="verificarAgendados.php">Voltar</a></button>
