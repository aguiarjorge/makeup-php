                                ...
                                <div class="col-lg-4 col-md-12 profile-menu mb-4 m-lg-0">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item seguranca-link">
                                            <a href="verificarAgendados.php" class="nav-link">
                                    ...
                                    <div class="row p-3">
                                        <div class="col">
                                            ...
                                            <form action="action/atualizar.php" method="POST" class="simple-form edit_user">
                                                ...
                                                <input type="text" hidden name="idUsuario" value="<?php echo $_SESSION['idUsuario']; ?>">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4">
                                                            <div class="input-box">
                                                                <label for="number">Celular</label> <input id="number" type="tel" name="telefoneUsuario" placeholder="Somente Números" onkeypress="$(this).mask('(00) 0000-00009')" required value="<?php echo $dados['telefoneUsuario']; ?>">
                                                            </div>

                                                        </div>
                                                        <div class="col-4">
                                                            <div class="input-box">
                                                                <label for="number">Senha</label> <input id="number" type="password" name="senhaUsuario" placeholder="" required value="<?php echo $dados['senhaUsuario']; ?>">
                                                            </div>
