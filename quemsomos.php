...
<meta name="theme-color" content="#ffffff">
    ...
    <title>Makeup Queen :: Quem Somos</title>
</head>
...
session_start();
        ...
        <main class="flex-fill">
            <div class="container">
                ...
                <hr>
                <p>
                  Nós somos um time de maquiadoras apaixonadas pelo que fazemos. Todas nós fizemos o curso de maquiagem no SENAC de Nova Iguaçu, onde aprendemos técnicas avançadas e nos aprimoramos para oferecer o melhor serviço possível para nossas clientes.
                </p>
                <p>
                  Com a nossa formação, decidimos empreender na cidade de Belford Roxo e abrir um salão de beleza especializado em maquiagem. Com muito esforço, trabalho árduo e dedicação, nosso salão cresceu e se tornou um dos mais famosos do Rio de Janeiro.
                </p>
                <p>
                  Estamos comprometidas em oferecer um atendimento de qualidade, utilizando apenas os melhores produtos e técnicas mais atualizadas do mercado. Nós amamos ajudar nossas clientes a realçar sua beleza natural e a se sentirem confiantes em sua própria pele.
                </p>
                <p>
                  Nossa equipe é formada por cinco mulheres fortes e talentosas, cada uma com sua própria especialidade e estilo único. Estamos sempre buscando nos aprimorar e evoluir, e estamos muito orgulhosas do trabalho que fazemos.
                </p>
                <p>
                  Se você está procurando um salão de beleza em que pode confiar para sua maquiagem, venha nos visitar. Estamos ansiosas para ajudá-la a se sentir linda e confiante em qualquer ocasião!
                </p>
            </div>
        </main>
